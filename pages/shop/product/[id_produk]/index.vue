<script setup>
  ...
  store.setProductData(data.value)
      ...
      <!-- Product Section Start -->
       <section class="mt-14">
        ...
        <div class="grid grid-cols-2">
          ...
          <!-- Img Product -->
          <div class="w-full">
              <div class="w-full h-[500px] mb-5 bg-slate-100 rounded-lg"><img :src="`/_nuxt/assets/img/${data.foto}`" class="object-cover w-full h-full"></div>
            <div class="grid grid-cols-3 gap-5">
              <div class="h-32 rounded-lg bg-slate-100"><img :src="`/_nuxt/assets/img/${data.foto}`" class="object-cover object-top w-full h-full"></div>
              <div class="h-32 rounded-lg bg-slate-100"><img :src="`/_nuxt/assets/img/${data.foto}`" class="object-cover object-top w-full h-full"></div>
              <div class="h-32 rounded-lg bg-slate-100"><img :src="`/_nuxt/assets/img/${data.foto}`" class="object-cover object-top w-full h-full"></div>
            </div>
          </div>
          ...
          <div class="flex justify-center w-full h-full mb-96">
            <div class="w-[450px] h-96 mt-5">
              ...
              <div class="my-5">
                ...
                <div class="flex flex-wrap gap-2">
                  <button
                    ...
                    class="px-5 py-1 font-serif rounded-full transition-colors duration-200"
                    :class="[
              ...
              <div class="flex gap-3">
                ...
                <NuxtLink 
                  :to="`/shop/product/${data.id_produk}/checkout`" 
            ...
            <div class="grid grid-cols-3 gap-6">
              <div class="border-2 rounded-xl bg-white w-[320px] h-54 p-4 mx-auto">
                ...
                <p class="flex mt-2 text-xs text-justify text-gray-600">
                  "Kebaya kutu baru ini benar-benar memenuhi ekspektasi saya! Bahan yang digunakan sangat nyaman di kulit, bahkan saat dipakai seharian. Motif batiknya elegan dan terlihat sangat berkelas, sempurna untuk acara formal maupun semi-formal. "
                </p>
